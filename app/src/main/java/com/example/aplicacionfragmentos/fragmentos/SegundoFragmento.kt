...
class SegundoFragmento : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Obtén la referencia al botón de anterior
        val buttonAnterior = view.findViewById<View>(R.id.button_second)

        // Agrega un OnClickListener al botón
        buttonAnterior.setOnClickListener {
            // Navega hacia atrás en el controlador de navegación
